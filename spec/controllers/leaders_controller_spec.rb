...
describe LeadersController do
  ...
  let(:valid_attributes) { { "contituent_id" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved leader as @leader" do
        ...
        post :create, {:leader => { "contituent_id" => "invalid value" }}, valid_session
        assigns(:leader).should be_a_new(Leader)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested leader" do
        ...
        Leader.any_instance.should_receive(:update_attributes).with({ "contituent_id" => "MyString" })
        put :update, {:id => leader.to_param, :leader => { "contituent_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the leader as @leader" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Leader.any_instance.stub(:save).and_return(false)
        put :update, {:id => leader.to_param, :leader => { "contituent_id" => "invalid value" }}, valid_session
        assigns(:leader).should eq(leader)
      end
